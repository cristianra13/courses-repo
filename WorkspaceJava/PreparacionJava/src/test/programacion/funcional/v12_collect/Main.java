    ...
    public Main()
    {
        ...
        /*
            ...
            la primera le decimos que queremos como clave del mapa
             ...
             Function.identity(): metodo static predefinido al que podemos decirle que lo que recibimos es lo mismo que retornamos.
         */
        ...
        Map<String, Book> resultT =  myBooks.stream()
                .filter(book -> book.getYear() < 2000)
                /*
                    combinamos los dos libros repetidos, es el que en el nombre está con +
