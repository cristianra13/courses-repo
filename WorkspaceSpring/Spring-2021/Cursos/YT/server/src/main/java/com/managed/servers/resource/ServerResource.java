package com.managed.servers.resource;

import com.managed.servers.enumeration.Status;
import com.managed.servers.models.Response;
import com.managed.servers.models.Server;
import com.managed.servers.service.impl.ServerServiceImpl;
...
public class ServerResource {
  ...
  public byte[] getServerImage(@PathVariable String fileName) throws IOException {
    return Files.readAllBytes(Paths.get(System.getProperty("user.home") +
        "/Documents/workspaces/personal-courses/WorkspaceSpring/Spring-2021/courses/YT/images/" +
        fileName));
  }
